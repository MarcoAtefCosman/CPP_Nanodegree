...
//         cout << "the key is not defined yet!" <<endl;
//         my_dict[key] = vector<string> {def_1,def_2,def_3,def_4};
//     }
    
//     //iterate through the map:
//     auto defs = my_dict[key];
//     for(auto def:defs){
//         cout <<def <<endl;
//     }
// }
...
//     int check_key = 960;
//     if(phone_codes.find(check_key)==phone_codes.end()){
//         cout << "the key is not found ! "<<check_key<<endl;
//         phone_codes[check_key]  = "Maldives";
//     }

//     if(phone_codes.find(check_key) != phone_codes.end()){
//         cout << "the key is stored suucessfully! "<<check_key<<endl;
//         cout << "the corresponding country is : "<<phone_codes[check_key]<<endl;
//     }

//     //iterate through keys:
//     vector<int> selected_keys {20,971,960};
//     for(auto key:selected_keys){
//         cout <<phone_codes[key]<<endl;
//     }
// }